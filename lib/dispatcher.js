    ...
    async dispatch (request, response) {
        ...
        if(handler.before && typeof handler.before === 'function'){
            try{
                ...
                console.error(`Error executing method 'before' on '${handlerName}': ${e}`);
        ...
        try{
            ...
            console.error(`Error executing method '${httpMethod}' on '${handlerName}': ${e}`);
            response.statusCode = 500;
            return;
        }
        ...
        if(handler.after && typeof handler.after === 'function'){
            try{
                ...
                console.error(`Error executing method 'after' on '${handlerName}': ${e}`);
                response.statusCode = 500;
                return;
            }
        }
